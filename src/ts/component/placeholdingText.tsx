...
export default class LongArticle extends React.Component {
    render() {
        const p1 = 
        `古之學者1必有師。師者，所以傳道受業解惑也2。人非生而知之3者，孰能無惑？惑而不從師，其為惑也4，終不解矣。
        生乎吾前5，其聞6道也固先乎吾，吾從而師之7；生乎吾後，其聞道也亦先乎吾，吾從而師之。吾師道也8，夫庸知其年之先後生於吾乎9？
        是故10無11貴無賤，無長無少，道之所存師之所存也。`;
        const p2 =
        ...
        問之，則曰：“彼與彼年相若也，道相似也，位卑則足羞，官盛則近諛。”嗚呼！師道之不復可知矣。
        巫醫樂師百工之人，君子不齒，今其智乃反不能及，其可怪也歟！`;
        const p3 =
        `聖人無常師。孔子師郯子、萇弘、師襄、老聃。郯子之徒，其賢不及孔子。孔子曰：“三人行，則必有我師”。
