        ...
        return (
            <svg className="icon" style={this.props.style} viewBox="0 0 28 28" version="1.1" >
                ...
                <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                    <polygon fill="#9B9B9B" fillRule="nonzero" points="15 18 15 14 11 14 11 22 15 22.001 15 20 23 20 23 28 15 28 15 24 9 24 9 8 5 8 5 0 13 0 13 8 11 8 11 12 15 12 15 10 23 10 23 18"></polygon>
                </g>
            </svg>
        );
    }
    ...
    render() {
        return (
            <svg className="icon" style={this.props.style} viewBox="0 0 26 26" version="1.1">
                <title>label</title>
                <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                    <g transform="translate(-1.000000, -1.000000)" fill="#9B9B9B" fillRule="nonzero">
