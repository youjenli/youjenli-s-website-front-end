...
export default class HintOfFeatureLink extends React.Component<HintOfFeatureLinkProps> {
    render() {
        ...
        */
        ...
        const rowsInHint = Math.ceil(this.props.hint.length / maxCharactersPerRow);
        ...
        const leftShiftOfHintBody = (-widthOfHintBody + this.props.fontSizeOfFeatureLink * this.props.charactersOfFeatureLink) / 2;
        let styleOfPoint = {
