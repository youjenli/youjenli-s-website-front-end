...
import {fakeDate, fakeCategories, fakeTags} from './fake-posts-for-test';
...
export const fakePost:Post = {
    ...
    <ol id="toc">
        <li><a href="#p2">卻說魯肅、孔明辭了玄德、劉琦，玄</a>
            <ol>
                <li><a href="#p2">sub list 1</a>
                    <ol>
                        <li><a>3rd level list</a>
                            <ol>
                                <li><a>4th level list</a>
                                    <ol>
                                        <li>5th level list</li>
                                    </ol>
                                </li>
                            </ol>                        
                        </li>
